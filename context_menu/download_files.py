...
def on_download_requested(download: "QWebEngineDownloadRequest", webview:"ResizableWebView"):
    ...
    if file_ex in IMAGE_EXTENSIONS:
        print("Image file")
        str_dl_file_type = "Image file"
    elif file_ex in AUDIO_EXTENSIONS:
        print("Audio file")
        str_dl_file_type = "Audio file"
    elif file_ex in VIDEO_EXTENSIONS:
        print("Video file")
        str_dl_file_type = "Video file"
    else:
        print("Unknown file type")
        str_dl_file_type = "Unknown file"
        # return
    ...
    if mw.state == 'review':
        type_action = QAction(f"[ Download {str_dl_file_type} ]")
