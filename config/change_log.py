...
OLD_CHANGE_LOG = """
-----
2026-07-21: Fixed a bug ChatGPT TTS not working.
2026-05-16: Fixed a bug ChatGPT not working.
2026-05-04: Fixed a bug that caused high CPU usage.
----

2026-04-21: Added support for the Onigiri add-on.
...
Note: Occasionally errors may occur when updating the add-on. If that happens please close the add-on via the option and try again. (Tools -> Anki Terminator ->  Completely close sideber)
